...
<main class="page-container">
  ...
  <section class="hero-slider">
    <div class="slider">
      <img src="images/runninghero1.webp" class="slide active" alt="Hero 1">
      <img src="images/runninghero2.webp" class="slide" alt="Hero 2">
      <img src="images/runninghero3.webp" class="slide" alt="Hero 3">
    ...
    <div class="product-grid">
      <?php if (empty($products)): ?>
        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
          <h3>No running products available</h3>
      ...
      <?php else: ?>
        ...
        <div class="product-card<?php echo $index >= 8 ? ' hidden-card' : ''; ?>">
          ...
          <div style="position: relative;">
              <img src="<?php echo $product['image_path'] ?: 'images/running1.jpg'; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateVisibility() {
      ...
      if (btnMore) {
        btnMore.style.display = visibleCount >= cards.length ? 'none' : 'inline-flex';
      }
      if (btnAll) {
        btnAll.style.display = visibleCount >= cards.length ? 'none' : 'inline-flex';
      }
    }
