...
<main class="page-container">
  ...
  <section class="hero-slider">
    <div class="slider">
      <img src="images/fitnesshero1.jpg" class="slide active" alt="Hero 1">
      <img src="images/fitnesshero2.jpg" class="slide" alt="Hero 2">
      <img src="images/fitnesshero3.jpg" class="slide" alt="Hero 3">
      ...
      <?php for ($i = 1; $i <= 14; $i++): ?>
        <div class="product-card">
          <div style="position: relative;">
            <img src="images/fitness<?= $i ?>.jpg" alt="Product <?= $i ?>">
