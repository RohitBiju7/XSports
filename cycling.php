...
<main class="page-container">
  ...
  <section class="hero-slider">
    <div class="slider">
      <img src="images/cyclinghero1.webp" class="slide active" alt="Hero 1">
      <!-- <img src="images/cyclinghero2.jpg" class="slide" alt="Hero 2">
      <img src="images/cyclinghero3.jpg" class="slide" alt="Hero 3"> -->
    ...
    <div class="product-grid">
      <?php if (empty($products)): ?>
        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
          <h3>No cycling products available</h3>
        ...
        <?php $index = 0; foreach ($products as $product): ?>
          <div class="product-card<?php echo $index >= 8 ? ' hidden-card' : ''; ?>">
            ...
            <div style="position: relative;">
              <img src="<?php echo $product['image_path'] ?: 'images/cycling1.jpg'; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
