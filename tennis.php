...
// Fetch tennis products from database
...
<main class="page-container">
  ...
  <section class="hero-slider">
    <div class="slider">
      <img src="images/tennishero1.webp" class="slide active" alt="Hero 1">
      <img src="images/tennishero2.webp" class="slide" alt="Hero 2">
      <img src="images/tennishero3.webp" class="slide" alt="Hero 3">
    ...
    <div class="product-grid">
      <?php if (empty($products)): ?>
        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
          <h3>No tennis products available</h3>
      ...
      <?php else: ?>
        ...
        <div class="product-card<?php echo $index >= 8 ? ' hidden-card' : ''; ?>">
          ...
          <div style="position: relative;">
              <img src="<?php echo $product['image_path'] ?: 'images/tennis1.jpg'; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
