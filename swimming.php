...
<main class="page-container">
  ...
  <section class="hero-slider">
    <div class="slider">
      <img src="images/swimminghero1.webp" class="slide active" alt="Hero 1">
      <img src="images/swimminghero2.webp" class="slide" alt="Hero 2">
    ...
    <div class="product-grid">
      <?php if (empty($products)): ?>
        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
          <h3>No swimming products available</h3>
        ...
        <?php foreach ($products as $product): ?>
          <div class="product-card">
            ...
            <div style="position: relative;">
              <img src="<?php echo $product['image_path'] ?: 'images/swimming1.jpg'; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
